...
( ' PP0001 ' , 1000 , ' PN0001 ' , ' 10-14 ' , 14000 ) ,
...
INSERT INTO team11_premium_payment VALUES ( ' PP0031 ' , 1160 , ' PN0031 ' , ' 2022-08-05 ' , 13700 );
INSERT INTO team11_premium_payment VALUES ( ' PP0032 ' , 1150 , ' PN0032 ' , ' 2022-10-07 ' , 14700 );
INSERT INTO team11_premium_payment VALUES ( ' PP0033 ' , 1060 , ' PN0033 ' , ' 2022-09-24 ' , 13750 );
update team11_premium_payment set team11_premium_payment_schedule=replace(team11_premium_payment_schedule,
' 10-14 ',' 2022-10-10 ') where team11_premium_payment_id= ' PP0001 '  ;
update team11_premium_payment set team11_premium_payment_schedule=replace(team11_premium_payment_schedule,
' 12-02 ',' 2022-11-10 ') where team11_premium_payment_id= ' PP0011 '  ;
update team11_premium_payment set team11_premium_payment_schedule=replace(team11_premium_payment_schedule,
' 9-09 ',' 2022-07-10 ') where team11_premium_payment_id= ' PP0030 '  ;
update team11_premium_payment set team11_premium_payment_schedule=replace(team11_premium_payment_schedule,
' 9-09 ',' 2022-07-10 ') where team11_premium_payment_id= ' PP0030 '  ;
update team11_premium_payment set team11_premium_payment_schedule=replace(team11_premium_payment_schedule,
' 2-02 ',' 2022-11-24 ') where team11_premium_payment_id= ' PP0002 '  ;
update team11_premium_payment set team11_premium_payment_schedule=replace(team11_premium_payment_schedule,
' 12-03 ',' 2022-11-24 ') where team11_premium_payment_id= ' PP0025 '  ;
update team11_premium_payment set team11_premium_payment_amount=replace(team11_premium_payment_amount,
14000 , 6000 ) where team11_premium_payment_id= ' PP0001 '  ;
...
INSERT INTO team11_claim VALUES
(' CL0016 ' , 1150 , ' AG0016 ' , 13455 , ' I0016 ' , ' Road Accident ' , ' 2022-8-18 ' , ' pending ');

 
update team11_claim set team11_cust_id=replace(team11_cust_id,1150,1040);
...
( ' CS0001 ' , ' CL0001 ' , 1000 , ' v0001 ' , ' 2021-2-18 ' , 11200.0 ) ,
( ' CS0002 ' , ' CL0002 ' , 1010 , ' v0002 ' , ' 2021-2-01 ' , 13200 ) ,
( ' CS0003 ' , ' CL0003 ' , 1020 , ' v0003 ' , ' 2021-6-08 ' , 11760 ) ,
( ' CS0004 ' , ' CL0004 ' , 1030 , ' v0004 ' , ' 2023-9-01 ' , 7875 ) ,
( ' CS0005 ' , ' CL0005 ' , 1040 , ' v0005 ' , ' 2021-11-15 ' , 12300 ) ,
( ' CS0006 ' , ' CL0006 ' , 1050 , ' v0006 ' , ' 2023-12-03 ' , 7665 ) ,
( ' CS0007 ' , ' CL0007 ' , 1060 , ' v0007 ' , ' 2022-10-27 ' , 13020 ) ,
( ' CS0008 ' , ' CL0008 ' , 1070 , ' v0008 ' , ' 2020-8-01 ' , 7770 ) ,
( ' CS0009 ' , ' CL0009 ' , 1080 , ' v0009 ' , ' 2022-9-06 ' , 10000.0 ) ,
( ' CS0010 ' , ' CL0010 ' , 1090 , ' v0010 ' , ' 2023-3-24 ' , 14190 ) ,
( ' CS0011 ' , ' CL0011 ' , 1100 , ' v0011 ' , ' 2023-3-20 ' , 6840 ) ,
( ' CS0012 ' , ' CL0012 ' , 1110 , ' v0012 ' , ' 2022-11-15 ' , 10125 ) ,
( ' CS0013 ' , ' CL0013 ' , 1120 , ' v0013 ' , ' 2021-6-11 ' , 10920 ) ,
( ' CS0014 ' , ' CL0014 ' , 1130 , ' v0014 ' , ' 2022-7-25 ' , 14355 ) ,
( ' CS0015 ' , ' CL0015 ' , 1140 , ' v0015 ' , ' 2022-7-10 ' , 12555 );
...
( ' D01 ' , ' Finance ', ' Trust Auto ' , ' 1904-728317 ' ) ,
( ' D02 ' , ' Sales ', ' Trust Auto ' , ' 2252-276353 ' ) ,
( ' D03 ' , ' Finance ', ' Launch Insurance ' , ' 1935-726998 ' ) ,
( ' D04 ' , ' Operations ', ' Launch Insurance ' , ' 0709-288220 ' ) ,
( ' D05 ' , ' Sales ' ,' CarX Insurance ' , ' 2486-101994 ' ) ,
( ' D06 ' , ' Finance ', ' CarX Insurance ' , ' 2424-723274 ' ) ,
( ' D07 ' , ' Operations ', ' Scoot Car ' , ' 2496-884980 ' ) ,
( ' D08 ' , ' HR ' ,' Scoot Car ' , ' 061-219313 ' ) ,
( ' D09 ' , ' Sales ', ' Merge Car ' , ' 0796-899567 ' ) ,
( ' D10 ' , ' Technology ' ,' Merge Car ' , ' 0538-433169 ' );
...
update team11_product set team11_product_type = replace(team11_product_type, ' yearly-Basis ',' Monthly-Basis ')
where team11_product_number=' PN0001 ' ;
update team11_product set team11_product_type = replace(team11_product_type, ' yearly-Basis ',' Monthly-Basis ')
where team11_product_number=' PN0005 ' ;
update team11_product set team11_product_type=replace(team11_product_type, ' Yearly-Basis ',' Month-Basis ')
where team11_product_number=' PN0002 ';
select * from team11_product;
...
select * from team11_claim where team11_cust_id = 1040;
...
select * from team11_PRODUCT where team11_PRODUCT_number = ' PN0001 ' ;
describe team11_PRODUCT;
select * from team11_office;
...
SELECT * FROM Team11_CUSTOMER AS c  INNER JOIN Team11_PREMIUM_PAYMENT AS pp 
 ...
 GROUP BY c.team11_cust_id having COUNT(v.team11_vehicle_id) > 1
 and pp.Team11_Premium_Payment_Schedule > curdate();
select curdate();

/* Query -5-Done*/
SELECT distinct v.* , pp.Team11_PREMIUM_PAYMENT_amount FROM Team11_VEHICLE AS v, Team11_Customer AS c,
Team11_PREMIUM_PAYMENT AS pp
WHERE c.Team11_Cust_Id = v.Team11_Cust_Id AND c.Team11_Cust_Id = pp.Team11_Cust_Id AND
v.Team11_Vehicle_Number < pp.Team11_Premium_Payment_amount /*premium is > 9000 except PP0001*/
ORDER BY v.Team11_Vehicle_Id ASC;
select distinct * from Team11_PREMIUM_PAYMENT;
/* QUery-6 - Done*/
